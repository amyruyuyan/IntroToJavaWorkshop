...
public class ScaryMaze extends JPanel implements Runnable, MouseMotionListener {
	...
	ScaryMaze() throws Exception {
		//1. Use this online tool to make a maze image and drop it into your section5 package: c
		maze = ImageIO.read(getClass().getResource("weirdo maze.jpg"));
	...
	private void scare() {
		...
		showScaryImage("weirdo clown.jpg");
	}
